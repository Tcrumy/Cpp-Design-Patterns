...
you wanted to used the bitmap class without immediately needing to load a bitmap, that can be done through the proxy class. This is based on Umar Lones "Struction Design Patterns" 
udemy course.
